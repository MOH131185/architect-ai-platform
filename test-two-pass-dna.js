...
import { repairDNA, ensureRequiredSections } from "./src/services/dnaRepair.js";
...
try {
  ...
  if (
    typeof normalized.site.area_m2 === "number" &&
    typeof normalized.program.floors === "number"
  ) {
...
const programSpec = {
  floors: 2,
  programSpaces: [{ name: "Living", area: 25, floor: "ground" }],
};

const payload = buildDNARequestPayload(
  locationData,
  siteMetrics,
  programSpec,
  null,
