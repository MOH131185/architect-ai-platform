...
export default async function handler(req, res) {
  ...
  try {
    const {
      ...
      repetition_penalty,
      stop,
      response_format, // Filtered out - not supported by Together.ai
    ...
    console.log(
      `🧠 [Together AI] Chat completion: ${effectiveModel} (deterministic: ${deterministicMode})`,
    );
    ...
    if (!response.ok) {
      ...
      // Extract error message string - data.error may be an object from Together AI
      const errorMsg =
