...
module.exports = {
  ...
  theme: {
    extend: {
      // =================================================================
      // COLORS - Royal Blue Brand Palette
      // =================================================================
      colors: {
        brand: {
          50: "#E8EEFF",
        ...
        // Semantic palettes — full 50–900 stops so on-dark surfaces can use
        // light tints (text-*-200/300) for icons + headings and use opacity
        // ramps (bg-*-500/10, border-*-500/30) for surface tinting.
        success: {
          50: "#ECFDF5",
          100: "#D1FAE5",
          200: "#A7F3D0",
      ...
      // =================================================================
      // SHADOWS - Apple/Linear/Vercel Style
      // =================================================================
      boxShadow: {
