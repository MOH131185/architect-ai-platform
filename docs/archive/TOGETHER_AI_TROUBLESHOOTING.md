...
const response = await fetch(
  "http://localhost:3001/api/enhanced-image/generate",
  {
    method: "POST",
    ...
    body: JSON.stringify({
      ...
      prompt:
        "Technical architectural floor plan, modern 2-story house, black lines on white background, CAD style, overhead view",
