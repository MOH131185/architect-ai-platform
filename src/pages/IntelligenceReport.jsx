      ...
      <div className="space-y-8 animate-fadeIn">
            ...
            <div className="grid grid-cols-3 gap-4 mt-6">
              ...
              <div className="bg-white/10 backdrop-blur rounded-xl p-4">
                ...
                <p className="text-lg font-semibold">
                  {locationData.recommendedStyle || "Contemporary"}
                </p>
              </div>
            </div>
          </div>
          ...
          {sunPath.optimalOrientation && (
            <div className="mt-4 p-4 bg-blue-50 rounded-xl">
              <p className="text-sm text-gray-700">
                <span className="font-semibold">Optimal Orientation:</span>{" "}
                {sunPath.optimalOrientation}
              </p>
            </div>
          )}
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6">
            ...
            {mapError && (
              <div className="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                ...
                <p className="text-red-600 text-xs mt-1">
                  Site boundary editing requires Google Maps. Please check your
          ...
          <p className="text-sm text-gray-500 mt-4">
            <strong>Draw your site boundary:</strong> Click on the map to place
            vertices. Hold Shift for 90° angles. Right-click to finish. Hover
            over corner markers to see them enlarge, then drag to adjust. Edit
            edge lengths and angles in the geometry panel on the right.
          </p>
          ...
          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              ...
              <li>
                • Hold <kbd className="px-2 py-1 bg-white rounded">Shift</kbd>{" "}
                to snap to 90° angles
              </li>
              <li>
                • Type numbers +{" "}
                <kbd className="px-2 py-1 bg-white rounded">Enter</kbd> for
                exact distances
              </li>
              <li>
                • Press <kbd className="px-2 py-1 bg-white rounded">ESC</kbd> to
                undo last point
              </li>
              <li>• Right-click when done (3+ vertices required)</li>
              <li>
                • <strong>Hover over numbered corner circles</strong> - they
                enlarge for easier grabbing
              </li>
              <li>
                • <strong>Drag corners</strong> to reshape the boundary visually
              </li>
