...
const PROJECT_GRAPH_BUILDING_TYPE_ALIASES = Object.freeze({
  ...
  "dental-clinic": "healthcare_dental",
  "healthcare-lab": "healthcare_laboratory",
  "healthcare-laboratory": "healthcare_laboratory",
  laboratory: "healthcare_laboratory",
  lab: "healthcare_laboratory",
  "education-university": "education_university",
  university: "education_university",
  campus: "education_university",
  "education-kindergarten": "education_kindergarten",
  kindergarten: "education_kindergarten",
  nursery: "education_kindergarten",
...
const PROJECT_GRAPH_PROGRAMME_TEMPLATE_ROWS = Object.freeze({
  ...
  commercial_retail: [
    [
      ...
      "customer arrival and display frontage",
      "public",
      0.06,
      0,
      "medium",
    ],
    ["Sales floor", "primary retail sales area", "public", 0.46, 0, "high"],
    [
      "Fitting or consultation area",
      "customer support and fitting",
      "semi_public",
      0.08,
      0,
      "medium",
    ...
    [
      "Stockroom",
      "stock holding and replenishment",
      "service",
      0.14,
      "upper",
      "low",
    ...
    [
      "Loading and refuse",
      "deliveries, goods-out and waste",
      "service",
      0.06,
      0,
      "low",
    ...
    [
      "Retail circulation and WCs",
      "customer circulation, stair and WCs",
      "semi_public",
      0.08,
      "upper",
      "medium",
  ...
  commercial_mixed_use: [
    ["Public lobby", "shared arrival and address", "public", 0.07, 0, "medium"],
    [
      "Active frontage",
      "retail, community or food frontage",
      "public",
      0.2,
      0,
      "high",
    ...
    [
      "Upper workplace",
      "workspace or community floorspace",
      "semi_public",
      0.25,
      "upper",
      "medium",
    ...
    [
      "Flexible studio units",
      "small flexible units",
      "semi_public",
      0.14,
      "upper",
      "medium",
    ...
    [
      "Back-of-house and stores",
      "servicing, stores and refuse",
      "service",
      0.08,
      0,
      "low",
    ...
    [
      "Mixed-use circulation core",
      "separated stair, lift and corridors",
      "semi_public",
      0.12,
      "upper",
      "medium",
  ...
  commercial_shopping_mall: [
    ["Main entrance mall", "public mall arrival", "public", 0.08, 0, "medium"],
    ["Anchor retail", "large-format retail unit", "public", 0.24, 0, "high"],
    [
      "Inline retail units",
      "smaller shop units",
      "public",
    ...
    [
      "Food and seating court",
      "food offer and seating",
      "public",
      0.1,
      "upper",
      "medium",
    ...
    [
      "Service corridor and loading",
      "back-of-house service route",
      "service",
      0.1,
      0,
      "low",
    ...
    [
      ...
      "concourse, escalator, lift and stair",
      "semi_public",
      0.1,
      "upper",
      "medium",
  ...
  healthcare_dental: [
    ...
    [
      "Decontamination suite",
      "clean and dirty decontamination",
      "service",
      0.1,
      "upper",
      "low",
    ],
    ["Imaging room", "dental imaging and x-ray", "clinical", 0.08, 0, "low"],
    [
      "Clean store and lab bench",
      "clinical storage and lab support",
      "service",
      0.08,
      "upper",
      "low",
    ...
    [
      "Staff and admin",
      "staff base and administration",
      "private",
      0.08,
      "upper",
      "medium",
    ],
    ["Accessible WC", "accessible patient WC", "service", 0.05, 0, "low"],
    [
      "Dental plant and circulation",
      "compressor, suction, stair and corridor",
      "service",
      0.15,
      "upper",
      "medium",
  ...
  healthcare_laboratory: [
    [
      "Reception and sample drop-off",
      "controlled arrival and sample handover",
      "public",
      0.06,
      0,
      "medium",
    ...
    [
      "Wet laboratory",
      "wet lab benches and controlled work",
      "technical",
      0.3,
      "upper",
      "medium",
    ...
    [
      "Dry laboratory",
      "analysis and dry technical work",
      "technical",
      0.18,
      "upper",
      "medium",
    ...
    [
      "Clean stores and cold room",
      "clean stores, cold room and supplies",
      "service",
      0.1,
      "upper",
      "low",
    ...
    [
      "Write-up and admin",
      "write-up, office and staff base",
      "private",
      0.08,
      "upper",
      "medium",
    ...
    [
      "Laboratory plant and circulation",
      "extraction, plant, stair and corridor",
      "service",
      0.1,
      "upper",
      "low",
  ...
  education_university: [
    [
      "Student services and arrival",
      "arrival and student services",
      "public",
      0.06,
      0,
      "medium",
    ...
    [
      ...
      "library, quiet study and commons",
      "semi_public",
      0.12,
      "upper",
      "medium",
    ...
    [
      "Cafe and student amenity",
      "student cafe and informal amenity",
      "public",
      0.08,
      0,
      "medium",
    ...
    [
      "Academic services and circulation",
      "stores, WCs, plant, stair and corridors",
      "service",
      0.12,
      "upper",
      "medium",
  ...
  education_kindergarten: [
    [
      "Secure arrival and reception",
      "secure arrival and parent handover",
      "public",
      0.08,
      0,
      "medium",
    ...
    [
      "Early-years play rooms",
      "play, learning and activity rooms",
      "teaching",
      0.36,
      0,
      "high",
    ...
    [
      "Stores and buggy park",
      "toy store, cleaner and buggy storage",
      "service",
      0.06,
      0,
      "low",
    ...
    [
      "Kindergarten plant and circulation",
      "plant, stair and circulation",
      "semi_public",
      0.12,
      "upper",
      "medium",
