...
class IntelligentLevelAssignment {
  ...
  initializeLevelRules() {
    return {
      ...
      reception: {
        ...
        priority: 100,
        reason: "Main entry point - accessibility",
      },
      lobby: {
        preferredLevel: "Ground",
        priority: 100,
      ...
      entrance: {
        preferredLevel: "Ground",
        priority: 100,
        reason: "Building entry",
      },
      "waiting area": {
        preferredLevel: "Ground",
        priority: 95,
        reason: "Public access - accessibility",
      },
      "reception/lobby": {
        preferredLevel: "Ground",
        priority: 100,
      ...
      "emergency department": {
        preferredLevel: "Ground",
        priority: 100,
        reason: "Emergency access critical",
      },
      ...
      "sales floor": {
        preferredLevel: "Ground",
        priority: 90,
        reason: "Public access and visibility",
      },
      "checkout area": {
        preferredLevel: "Ground",
        priority: 90,
        reason: "Part of main sales floor",
      },
      retail: {
        preferredLevel: "Ground",
        priority: 85,
        reason: "Customer accessibility",
      },
      shop: {
        preferredLevel: "Ground",
        priority: 85,
      ...
      "consultation room": {
        preferredLevel: "Ground",
        priority: 85,
        reason: "Patient accessibility",
      },
      "treatment room": {
        preferredLevel: "Ground",
        priority: 85,
        reason: "Patient care accessibility",
      },
      "x-ray room": {
        preferredLevel: "Ground",
        priority: 75,
        reason: "Heavy equipment",
      },
      laboratory: {
        preferredLevel: "Ground",
        priority: 70,
        reason: "Equipment and access",
      },
      pharmacy: {
        preferredLevel: "Ground",
        priority: 75,
      ...
      kitchen: {
        preferredLevel: "Ground",
        priority: 80,
        reason: "Service delivery access",
      },
      "loading bay": {
        preferredLevel: "Ground",
        priority: 95,
        reason: "Vehicle access required",
      },
      storage: {
        preferredLevel: "Ground",
        priority: 60,
        fallback: "Basement",
        reason: "Flexible placement",
      },
      "mechanical room": {
        preferredLevel: "Basement",
        priority: 70,
        reason: "Noise isolation",
      },
      "plant room": {
        preferredLevel: "Basement",
        priority: 70,
        fallback: "Roof",
        reason: "Service distribution",
      },
      laundry: {
        preferredLevel: "Ground",
        priority: 70,
      ...
      "open office": {
        preferredLevel: "First",
        priority: 60,
        reason: "Natural light and quiet",
      },
      "private office": {
        preferredLevel: "First",
        priority: 60,
        reason: "Privacy and focus",
      },
      "meeting room": {
        preferredLevel: "First",
        priority: 50,
      ...
      "executive office": {
        preferredLevel: "Second",
        priority: 50,
        reason: "Top floor prestige",
      },
      administration: {
        preferredLevel: "First",
        priority: 60,
      ...
      "living room": {
        preferredLevel: "Ground",
        priority: 85,
        reason: "Main living area - entry level",
      },
      bedroom: {
        preferredLevel: "First",
        priority: 80,
        reason: "Privacy and security on upper floor",
      },
      "master bedroom": {
        preferredLevel: "Second",
        priority: 75,
      ...
      bathroom: {
        preferredLevel: "First",
        priority: 70,
        reason: "Near bedrooms",
      },
      "en-suite": {
        preferredLevel: "First",
        priority: 75,
        reason: "Attached to bedroom",
      },
      ...
      classroom: {
        ...
        priority: 75,
        fallback: "First",
        reason: "Accessibility for students",
      },
      library: {
        preferredLevel: "First",
        priority: 65,
      ...
      "science lab": {
        preferredLevel: "Ground",
        priority: 80,
        reason: "Equipment and safety",
      },
      "computer lab": {
        preferredLevel: "First",
        priority: 60,
        reason: "Climate controlled",
      },
      gymnasium: {
        preferredLevel: "Ground",
        priority: 90,
        reason: "High ceiling and accessibility",
      },
      "assembly hall": {
        preferredLevel: "Ground",
        priority: 90,
        reason: "Large gathering space",
      },
      cafeteria: {
        preferredLevel: "Ground",
        priority: 85,
      ...
      "guest room": {
        preferredLevel: "First",
        priority: 70,
        reason: "Upper floors for privacy",
      },
      "hotel room": {
        preferredLevel: "First",
        priority: 70,
      ...
      "swimming pool": {
        preferredLevel: "Ground",
        priority: 80,
        reason: "Structural and waterproofing",
      },
      "spa/wellness": {
        preferredLevel: "First",
        priority: 60,
        fallback: "Basement",
        reason: "Tranquil environment",
      },
      gym: {
        preferredLevel: "Ground",
        priority: 70,
      ...
      corridor: {
        preferredLevel: "All",
        priority: 100,
        reason: "Required on every floor",
      },
      circulation: {
        preferredLevel: "All",
        priority: 100,
      ...
      "server room": {
        preferredLevel: "Ground",
        priority: 70,
        reason: "Climate control and security",
      },
      "electrical room": {
        preferredLevel: "Basement",
        priority: 75,
      ...
      "wc block": {
        preferredLevel: "Ground",
        priority: 80,
        reason: "Multiple floors if needed",
      },
  ...
  assignLevels(programSpaces, buildingSpec = {}) {
    ...
    const spacesWithLevels = programSpaces.map((space, index) => {
      const assignment = this.assignLevelToSpace(
        space,
        availableFloors,
        category,
        subType,
    ...
    const balancedSpaces = this.balanceFloorsIfNeeded(
      spacesWithLevels,
      availableFloors,
      floorCount,
    );
  ...
  assignLevelToSpace(space, availableFloors, category, subType, allSpaces) {
    ...
    // Try partial match
      ...
      for (const [key, value] of Object.entries(this.levelRules)) {
        if (
          key !== "default" &&
          (spaceName.includes(key) || key.includes(spaceName.split(" ")[0]))
        ) {
          rule = value;
          matchType = "partial";
          break;
  ...
  applyBuildingTypeAdjustments(
    ...
    if (category === "healthcare") {
      if (
        spaceName.includes("patient") ||
        spaceName.includes("consultation") ||
        spaceName.includes("treatment") ||
        spaceName.includes("waiting")
      ) {
        return "Ground";
      }
    }
  ...
  balanceFloorsIfNeeded(spaces, availableFloors, floorCount) {
    ...
    if (groundPercentage > 0.7 && availableFloors.length > 1) {
      ...
      const flexibleSpaces = spaces.filter(
        (s) =>
          s.level === "Ground" &&
      ...
      const toMove = Math.min(
        flexibleSpaces.length,
        Math.floor(groundCount * 0.2),
      );
  ...
  validateLevelAssignments(spaces) {
    ...
    const hasReception = groundSpaces.some(
      (s) =>
        s.label?.toLowerCase().includes("reception") ||
        s.label?.toLowerCase().includes("entrance"),
    );
    ...
    Object.entries(floorCounts).forEach(([floor, count]) => {
      if (count === 1 && floor !== "Basement") {
        warnings.push(
          `Only one space assigned to ${floor} floor - consider redistribution`,
        );
      }
    });
